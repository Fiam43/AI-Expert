...
mp_draw = mp.solutions.drawing_skills
...
def detect_gesture(hand_landmarks, handedness):
    ...
    finger_tips_ids = [
        ...
        mp_hands.HandLandmark.MIDDLE_FIINGER_TIP,
    ...
    while True: 
        ...
        if results.multi_hand_landmarks and results.multi_handedness:
            ...
            for hand_landmarks, hand_info in zip(results.multi_hand_landmarks, results.multi_handedness):
                ...
                mp_draw.draw_lanndmarks(

                    img, hand_landmarks, mp_hands.HAND_CONNECTIONS,

                    mp_draw.DrawingSpec(colro=(0, 255, 0), thickness=2, circle_radius=2),
            ...
            cv2.putText(
                ...
                cv2.FONT_HERSHEY_SIMPLEX, 1, (25, 0, 0), 2
